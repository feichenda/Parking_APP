 ...
 * @annotation
 */
public class ChangeInfoSettingFragment extends BaseFragment {
    ...
    public ChangeInfoSettingFragment() {
        super(R.layout.fragment_reinfosetting);
    }
    ...
    protected void initView(View view) {
        ...
        client.isMerchantChange(merchantname, new BaseObserver<BaseModel<MerchantChange>>(getContext()) {
            @Override
            ...
            protected void defeated(BaseModel<MerchantChange> merchantChangeBaseModel) {
                showToast(merchantChangeBaseModel.getMessage());
            }
