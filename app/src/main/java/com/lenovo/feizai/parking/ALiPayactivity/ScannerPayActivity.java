 ...
 */
public class ScannerPayActivity extends AppCompatActivity {
...
//                            }
                        ...
                        ft.replace(R.id.container, payResultOrderFragment);
                        ft.commit();
                    } else {
    ...
    public void payV2(CheckInfo checkInfo) {
        ...
        final Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(ScannerPayActivity.this);
