 ...
 */
public class AddParkingActivity extends BaseActivity {
    ...
    public AddParkingActivity() {
        super(R.layout.activity_add_parking);
    }
    ...
    protected void initView() {
        ...
        certificate_list = new BaseRecyclerView<String, BaseViewHolder>(AddParkingActivity.this, R.id.certificate_list) {
            @Override
            public BaseQuickAdapter<String, BaseViewHolder> initAdapter() {
                CertificateAdapter certificateAdapter = new CertificateAdapter(AddParkingActivity.this, certificate);
                return certificateAdapter;
            }
        };
        certificate_list.setItemDecoration(new GridSpacingItemDecoration(3, 5, false));
        certificate_list.setLayoutManager(new GridLayoutManager(AddParkingActivity.this, 3));

        photo_list = new BaseRecyclerView<String, BaseViewHolder>(AddParkingActivity.this, R.id.photo_list) {
            @Override
            public BaseQuickAdapter<String, BaseViewHolder> initAdapter() {
                PhotoAdapter photoAdapter = new PhotoAdapter(AddParkingActivity.this, photo);
                return photoAdapter;
            }
        };
        photo_list.setItemDecoration(new GridSpacingItemDecoration(3, 5, false));
        photo_list.setLayoutManager(new GridLayoutManager(AddParkingActivity.this, 3));
        ...
        certificate_list.setOnItemClick(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                ...
                if (TextUtils.equals(data, "take")) {
                    OptionDialog optionDialog = new OptionDialog(AddParkingActivity.this);
                    ...
                    optionDialog.setOnBtnClickLister(new OptionDialog.OnBtnClickLister() {
                        @Override
                        public void first() {
                            SelectPhotoUtil.shoot(AddParkingActivity.this, new OnResultCallbackListener<LocalMedia>() {
                                @Override
                        ...
                        public void second() {
                            List<String> old = certificate_list.getData();
                            List<String> list = new ArrayList<>();
                            SelectPhotoUtil.select(AddParkingActivity.this, 4 - old.size(), new OnResultCallbackListener<LocalMedia>() {
                                @Override
                                public void onResult(List<LocalMedia> result) {
                    ...
                    ShowPhotoDialog photoDialog = new ShowPhotoDialog(AddParkingActivity.this);
        ...
        photo_list.setOnItemLongClick(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                if (TextUtils.equals(data, "take")) {
                    ...
                    MaterialDialog dialog = new MaterialDialog(AddParkingActivity.this, MaterialDialog.getDEFAULT_BEHAVIOR());
    ...
    public void sure() {
        ...
        client.addmerchantinfo(GsonUtil.GsonString(parkingInfo), GsonUtil.GsonString(location), GsonUtil.GsonString(rates), GsonUtil.GsonString(parkingNumber), license, image, new BaseObserver<BaseModel>(AddParkingActivity.this) {
            @Override
