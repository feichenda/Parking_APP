 ...
 * @annotation
 */
public class FirstOrderInfoFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        if (!TextUtils.isEmpty(orderjson)) {
            ...
            calendar.set(Calendar.MINUTE, calendar.get(Calendar.MINUTE) + order.getDuration());//加分钟数
            order.setState("已支付");
            ...
            client.addSubscribeOrder(json, part, new BaseObserver<BaseModel>(getContext()) {
                @Override
                ...
                protected void defeated(BaseModel baseModel) {
                    Log.e("tag", baseModel.getMessage());
                }
