...
public class CustomViewAbove extends ViewGroup {
	 ...
	 * layout there will be a smooth animated transition between the current text_item and the
	 * specified text_item.
	 *
	 ...
	 *
	 * @param item Item index to select
	 * @param smoothScroll True to smoothly scroll to the new text_item, false to transition immediately
	 */
