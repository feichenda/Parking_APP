...
import com.lenovo.feizai.parking.merchantfragment.MerchantPersonalDataFragment;
 ...
 * @annotation
 */
public class MerchantPersonalDataActivity extends BaseActivity {

    public MerchantPersonalDataActivity() {
    ...
    private void loadFragment(String flag){
        ...
        switch (flag){
            case "personal":
                MerchantPersonalDataFragment personal = new MerchantPersonalDataFragment();
